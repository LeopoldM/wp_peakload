...
\begin{theorem}\label{thm:welfare}
  ...
  \medskip
  \noindent\textbf{IR-unconstrained allocation.} (i)~If \eqref{COV1} holds for every $s$, then an increase in $k_i$ increases surplus for every type $\theta$. (ii)~If \eqref{COV1} is reversed, then $\tilde\theta_i^1$ is unique; individual surplus decreases for all $\theta<\tilde\theta_i^1$ and increases for all $\theta>\tilde\theta_i^1$.
  ...
  \begin{enumerate}[label=(\roman*), leftmargin=1cm]
    \item if \eqref{COV1} holds for every $s$, individual surplus decreases for all $\theta>\tilde\theta_i^1$ and increases for all $\theta<\tilde\theta_i^1$;
