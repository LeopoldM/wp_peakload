...
Recall that $u(\cdot)>0$, $u_q(\cdot)<0$ and from assumption XXXX, we have $\G_i (\theta)\ge0$, then the IC constraint might not be satisfied whenever $\G_i' (\theta)<0$.
...
\section{A FAIRE/completer: Sufficient statistic}
...
\section{A FAIRE/completer: Single Crossing}
